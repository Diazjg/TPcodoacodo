 ...
 * @author fedem
 */
@WebServlet(urlPatterns = {"/CrearOradorServlet"})
public class CrearOradorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Orador oradorActualizado = new Orador();
                ...
                oradoresDAO.agregarOrador(oradorActualizado);
                response.sendRedirect("verOradores.jsp");
    }
