...
<html>
    ...
    <body>
        <div class="container mt-5">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <%
                        ...
                        /*Orador oradoor = new Orador();
                        oradoor.setApellido("Diaz");
                        oradoor.setNombre("Javier");
                        oradoor.setTema("Salud");
                        
                        Date dd = new Date(123, 9, 10);
                        
                        oradoor.setFechaAlta(dd);
                        oradoresDAO.agregarOrador(oradoor);*/
            ...
            <a href="nuevoOrador.jsp" class="btn btn-success">Crear Orador</a>   
        </div>
    </body>
</html>
